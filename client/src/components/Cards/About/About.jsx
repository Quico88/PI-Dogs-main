    ...
    return (
        <div className={s.about}>
            ...
            <div className={s.aboutContent}>
                ...
                <p>Additionally, users are able to go through a complete CRUD cycle while creating, reading, updating and deleting their own dog breeds. These breeds are stored in a SQL database which was created with PostgreSQL and is manipulated through Sequelize.</p>
               <p>All dog breeds -from the API and created by users - are rendered in pages up to 9 dogs, and they can be filtered in a combined way by source and by Temperaments.
                In addition, the desired selection of dogs can be sorted either by weight or alphabetically, in both ascendent and descendent ways.
                ...
                <p>Thanks for visiting Dogify!</p>
