...
let sequelize = 
  ...
  ? new Sequelize({
    ...
    ssl: true,
  }) : new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/henrydogsjfd`, {logging: false, native: false });



// const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/henrydogsjfd`, {
